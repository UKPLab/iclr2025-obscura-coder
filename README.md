...
# arxiv2024_obscuracoder
[![Arxiv](https://img.shields.io/badge/Arxiv-YYMM.NNNNN-red?style=flat-square&logo=arxiv&logoColor=white)](https://put-here-your-paper.com)
[![License](https://img.shields.io/github/license/UKPLab/arxiv2024-ObscuraCoder)](https://opensource.org/licenses/Apache-2.0)
[![Python Versions](https://img.shields.io/badge/Python-3.9-blue.svg?style=flat&logo=python&logoColor=white)](https://www.python.org/)
[![CI](https://github.com/UKPLab/arxiv2024-ObscuraCoder/actions/workflows/main.yml/badge.svg)](https://github.com/UKPLab/arxiv2024-ObscuraCoder/actions/workflows/main.yml)
...
To import classes/methods of `arxiv2024_obscuracoder` from inside the package itself you can use relative imports: 
...
```py
from arxiv2024_obscuracoder import BaseClass # Notice how I omit the file name
from arxiv2024_obscuracoder.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `arxiv2024_obscuracoder` from command line:

```bash
$ python -m arxiv2024_obscuracoder
```
